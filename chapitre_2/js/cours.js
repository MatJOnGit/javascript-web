console.log(document.body.childNodes[5].childNodes[1]); // Affiche h2

var titresElts = document.getElementsByTagName("h2"); // Stock tous les h2 dans une variable titresElts
...
console.log(document.querySelector("p")); // Affiche les infos du premier <p>
...
console.log(document.getElementById("antiques").classList.length);// Affiche 1 : l'élément possède une seule classe
console.log(document.getElementById("antiques").classList[0]); // Affiche "merveilles"
